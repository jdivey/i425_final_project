...
<form class="form-signup" style="display: none">
    ...
    <h1 class="h3 mb-3 font-weight-normal" style="padding: 20px; color: #FFFFFF; background-color: #316AC5">Create
        an account at MyCollege</h1>
    <div style="width: 250px; margin: auto">
        ...
        <p style="padding-top: 10px;">Already have an account? <a id="mycollege-signin" href="#signin">Sign in</a></p>
    </div>
</form>
